...
def _add_generic_args(parser):
    ...
    parser.add_argument('--batch-size', type=int, default=64, metavar='N',
                        help='input batch size for training (default: 32)')
    parser.add_argument('--query-budget', type=float, default=0.82, metavar='N',
                        help='Query budget for the extraction attack in millions (default: 20M)')
    parser.add_argument('--lr-S', type=float, default=0.001, metavar='LR', help='Student learning rate (default: 0.1)')
    parser.add_argument('--lr-G', type=float, default=1e-4, help='Generator learning rate (default: 0.1)')
    parser.add_argument('--nz', type=int, default=32, help='Size of random noise input to generator')
    parser.add_argument('--suffix', type=str, default=None,
                        help='Optional suffix to append at the end of the experiment name.')

    parser.add_argument('--rep-iter', type=int, default=3, help="Number of consecutive times to sample from replay")
    ...
    parser.add_argument('--lambda-bd', type=float, default=0,
                        help='bd loss weight')

    parser.add_argument('--log-interval', type=int, default=20, metavar='N',
                        help='how many batches to wait before logging training status')
    parser.add_argument('--loss', type=str, default='l1', choices=['l1', 'hl'],
    ...
    # parser.add_argument('--steps', nargs='+', default=[0.2, 0.6, 0.8], type=float,
    #                     help="Percentage epochs at which to take next step")
    parser.add_argument('--scale', type=float, default=3e-1, help="Fractional decrease in lr")
    parser.add_argument('--replay', type=str, default='Hybrid', choices=['Classic', 'Hybrid'])
    parser.add_argument('--replay-size', type=int, default=10000, help='Experience replay size')
    parser.add_argument('--dataset', type=str, default='cifar10', choices=['svhn', 'cifar10', 'mnist', 'cifar100', 'tinyimagenet'],
                        help='dataset name (default: cifar10)')
    parser.add_argument('--data-root', type=str, default='data')
    parser.add_argument('--grayscale', type=int, default=18,
                        help='Control grayscale generator generation. If set to value >= 1, Nth samples to grayscale.')
    # 教师模型
    # parser.add_argument('--model', type=str, default='resnet18_8x', choices=classifiers,
    ...
    # parser.add_argument('--seed', type=int, default=7000, metavar='S',
    #                     help='random seed')
    parser.add_argument('--seed', type=int, default=random.randint(0, 10000), metavar='S',
                        help='random seed')
    # 教师模型
    # parser.add_argument('--ckpt', type=str, default='checkpoint/teacher/cifar100-ensemble_resnet34_8x.pt')
    ...
    parser.add_argument('--experiment-type', type=str, default="mgct",
                        choices=["dfme", "mgct"],
...
def _add_separate_training_args(parser):
    ...
    parser.add_argument('--d-iter', type=int, default=1, help="Number of discriminator iterations per epoch_iter")
